---
title: Analisis forense digital y analisis y respuesta a incidentes
...
![image](https://hackmd.io/_uploads/BksJ8nWjWg.png)
...
## Verifique su Comprensión - Identifique los Pasos en el Proceso de Análisis Forense Digital

![image](https://hackmd.io/_uploads/r1E4Tn-iWe.png)
![image](https://hackmd.io/_uploads/HJXS63bi-l.png)
![image](https://hackmd.io/_uploads/B1526hZj-e.png)
![image](https://hackmd.io/_uploads/By-jpnWjWg.png)
...
## Verifique su comprensión - Identificar el Tipo de Evidencia

![image](https://hackmd.io/_uploads/SJ57kjfobe.png)
![image](https://hackmd.io/_uploads/Skmue99MjZg.png)
![image](https://hackmd.io/_uploads/Hk6Wc5GiZl.png)
![image](https://hackmd.io/_uploads/ryLQccGjbe.png)
...
![image](https://hackmd.io/_uploads/Bk8KccGiWl.png)
...
![image](https://hackmd.io/_uploads/rJLzxizs-l.png)
...
![image](https://hackmd.io/_uploads/Bk2RRxVoZl.png)

### Reconocimiento
![image](https://hackmd.io/_uploads/r1ZvkbEoWl.png)
![image](https://hackmd.io/_uploads/B1ptyZ4iZx.png)

### Armamentización
![image](https://hackmd.io/_uploads/rkVZlZEj-x.png)
![image](https://hackmd.io/_uploads/Sk6Qe-EoZe.png)

### Entrega
![image](https://hackmd.io/_uploads/r1-dgWVjbg.png)
![image](https://hackmd.io/_uploads/S1U5xb4ibg.png)

### Explotación
![image](https://hackmd.io/_uploads/BJdzQm4oZg.png)
![image](https://hackmd.io/_uploads/BJjw77Esbl.png)

### Instalación
![image](https://hackmd.io/_uploads/ry_iQ7Vo-g.png)
![image](https://hackmd.io/_uploads/B100QX4iZx.png)

### Comando y Control
![image](https://hackmd.io/_uploads/BygV4QNoWg.png)
![image](https://hackmd.io/_uploads/rJLSNQ4iZe.png)

### Acciones sobre Objetivos
![image](https://hackmd.io/_uploads/HJz6VQVsWe.png)
![image](https://hackmd.io/_uploads/SJpWU74j-e.png)

## Verifique su Comprensión - Identifique el Paso de la Cadena de Eliminación

![image](https://hackmd.io/_uploads/SymsIQEjZl.png)
![image](https://hackmd.io/_uploads/SyDnLmNj-x.png)
![image](https://hackmd.io/_uploads/r1O6LmNoZg.png)
![image](https://hackmd.io/_uploads/ByZ1v74j-e.png)
![image](https://hackmd.io/_uploads/rJmlvXNjWl.png)
...
![image](https://hackmd.io/_uploads/B1b2n74j-x.png)
...
![image](https://hackmd.io/_uploads/Bk_iyNEjbx.png)
...
1. * El adversario utiliza gadgets.com, el dominio que acaba de detectar, para realizar una nueva búsqueda de “administrador de red gadgets.com”. Así, descubre publicaciones de usuarios en los foros alegando que son administradores de red de gadgets.com. Los perfiles de usuario revelan sus direcciones de correo electrónico.
1. * El adversario envía correos electrónicos de suplantación de identidad con un troyano adjunto a los administradores de red de gadgets.com.
1. * Un administrador de red (NA1) de gadgets.com abre el archivo adjunto malicioso. Esto ejecuta el ataque incluido y permite seguir con la ejecución de código.
1. * El host atacado de NA1 envía un mensaje HTTP Post a una dirección IP para registrarla con un controlador de CnC. El host atacado de NA1 recibe una respuesta HTTP.
1. * Mediante ingeniería inversa, se revela que el malware tiene direcciones IP adicionales configuradas que actúan como una copia de respaldo si el primer controlador no responde.
1. * Mediante un mensaje de respuesta HTTP de CnC enviado al host de NA1, el malware comienza a actuar como un web proxy para nuevas conexiones de TCP.
1. * Mediante la información del proxy ejecutado en el host de NA1, el adversario realiza una búsqueda web con las palabras “la investigación más importante de todos los tiempos” y encuentra a la víctima 2, Interesting Research Inc.
1. * El adversario consulta la lista de contactos de correo electrónico de NA1 para buscar contactos de Interesting Research, Inc. y descubre el contacto del Director principal de investigaciones de Interesting Research, Inc.
1. * El Director principal de investigaciones de Interesting Research, Inc. recibe un correo electrónico de phishing dirigido desde la dirección de correo electrónico de NA1 de Gadget, Inc. enviado desde el host de NA1 con la misma carga útil del evento 3.
...
![image](https://hackmd.io/_uploads/Bk2GZVViZx.png)

## Verifique su Comprensión - Identifique las Características del Modelo de Diamante

![image](https://hackmd.io/_uploads/r1EKMENi-x.png)
![image](https://hackmd.io/_uploads/rJQqMEVsbe.png)
![image](https://hackmd.io/_uploads/ryFif4VoZx.png)
![image](https://hackmd.io/_uploads/B1Jaf4Eo-l.png)
![image](https://hackmd.io/_uploads/SJkRzN4iWe.png)
![image](https://hackmd.io/_uploads/SJY17VEobe.png)
...
![image](https://hackmd.io/_uploads/B1ffBLPo-l.png)
...
## Compruebe su Conocimiento - Identificar los Elementos del Plan de Respuesta a Incidentes

![image](https://hackmd.io/_uploads/Hy4twIws-e.png)
![image](https://hackmd.io/_uploads/Bk2cP8Di-g.png)
![image](https://hackmd.io/_uploads/r1KnPIvibg.png)
![image](https://hackmd.io/_uploads/By5aP8viZl.png)
![image](https://hackmd.io/_uploads/rJyyO8Pibx.png)
...
#### Departamento Legal
Es una mejor práctica tener un departamento de asuntos legales que revise políticas, planes y procedimientos relativos a los incidentes para asegurarse de que no violen pautas locales o federales. Además, si cualquier incidente tiene consecuencias jurídicas, un experto legal tendrá que involucrarse. Esto podría incluir acusaciones, recolección de evidencia o demandas.
...
![image](https://hackmd.io/_uploads/Bkm1sIPjWx.png)
...
