---
title: Lab - Recopilación de Información del Sistema Después de un Incidente

---

# Lab - Recopilación de Información del Sistema Después de un Incidente
Objetivos
...
b.  El último comando muestra una lista de los últimos usuarios conectados. Ingrese el comando con la opción -f para especificar el archivo de registro. El archivo de registro btmp muestra intentos fallidos de inicio de sesión. Su salida será diferente.
...
c.  Ingrese el comando last nuevamente especificando el archivo wtmp para mostrar quién está actualmente conectado al sistema. Su salida será diferente.
...
d.  Ingrese el comando exit para volver al usuario de Cisco.
