---
title: Lab - Gestión de riesgos

---

# Lab - Gestión de riesgos
Introducción
...
La organización puede implementar una política que prohíba a los empleados enviar correos electrónicos o transferir datos de clientes. La organización también podría evitar que los empleados tengan acceso a esta información. La organización también podría filtrar y bloquear todos los datos enviados por correo electrónico o transferidos desde la red de la organización.
...
Área de respuesta
Escriba sus respuestas aquí.
Implemente políticas y pautas para contraseñas de la organización y refuerce el uso de contraseñas seguras en todo el sistema de la organización.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar, pero se debe hacer referencia al uso de seguros o acuerdos de nivel de servicio.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. Negligencia significa que no se toman medidas o controles para reducir el riesgo. La amenaza es muy alta, y el costo de un incidente puede ser catastrófico y puede conducir a cargos criminals.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El debido cuidado implica tomar medidas razonables para reducir el nivel de riesgo. El riesgo aún existe, pero los pasos razonables reducen una posible pérdida. La debida diligencia implica medidas responsables tomadas para eliminar el riesgo. Todavía existen algunos riesgos, pero se implementan varios controles para evitar posibles pérdidas.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas variarán. Las vulnerabilidades pueden incluir fallas de hardware, ataques de hackers, desastres naturales, malware y configuraciones incorrectas.

Ocultar respuesta
Describa las posibles amenazas al servidor en función de las vulnerabilidades que identificó:

Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. Las amenazas al servidor deben incluir fallas de hardware basadas en fallas de equipos, una violación de datos o un ataque de ransomware, incendios, tornados, huracanes, terremotos, daños en el sistema debido a malware o fallas del sistema o mal funcionamiento debido a configuraciones incorrectas.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto podría variar desde la pérdida completa del servidor de base de datos hasta el impacto en las ventas y los ingresos para la organización. El impacto también podría incluir daños a la reputación comercial.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto podría variar desde la pérdida completa del servidor de base de datos hasta el impacto en las ventas y los ingresos para las organizaciones, y la interrupción de las operaciones regulares. El impacto también podría incluir daños a la reputación comercial.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. Las contramedidas para las violaciones de datos pueden incluir políticas o procedimientos actualizados, cifrado de datos, capacitación de empleados sobre medidas de seguridad, actualizaciones de seguridad y acceso limitado en función de la necesidad.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. Las medidas para contrarrestar el ataque de ransomware pueden incluir software antivirus y antimalware, sistemas operativos y aplicaciones actualizados, copias de seguridad de datos, políticas de seguridad y mecanismos de control de acceso físico.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. Las contramedidas para fallas de hardware pueden incluir redundancia de hardware, mecanismos de control de acceso y reemplazo de equipos obsoletos.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. Las contramedidas podrían incluir software antivirus y antimalware, sistemas operativos y aplicaciones actualizados, copias de seguridad de datos, aplicar políticas de seguridad y mecanismos de control de acceso físico.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto de una violación de datos podría costar $100,000 USD o más y 5 días hábiles para restaurar los datos.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto de una falla de hardware podría costar $5,000 USD o más y 2 días hábiles para reemplazar el hardware fallado.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto del ataque de ransomware podría costar $20,000 USD o más, y son 5 días hábiles para restaurar los datos y eliminar el rescate.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto de la inundación podría costar $50,000 USD o más y 3 días hábiles para reemplazar el hardware dañado y restaurar los datos.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto de una violación de datos es alto. Podría costar $100,000 USD o más y la confianza del cliente y la reputación de la empresa. Algunas de las soluciones de contramedida pueden ser la capacitación de los empleados, el cifrado de datos y las actualizaciones de software y hardware.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto de la falla de hardware del servidor es medio que podría costar $5,000 USD o más y la interrupción de servicios. Algunas de las contramedidas pueden ser copias de respaldo de datos y del sistema.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto del ataque de ransomware es bajo, lo que podría costar $20,000 USD o más. Podría causar la interrupción del servicio y la pérdida de datos. Algunas de las contramedidas pueden ser la capacitación en seguridad y el respaldo de datos.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. El impacto del ataque de ransomware es bajo, lo que podría costar $50,000 USD o más. Podría causar la interrupción del servicio y la pérdida de datos. Algunas de las contramedidas pueden ser compra de seguro y datos de respaldo.
...
Área de respuesta
Escriba sus respuestas aquí.
Las respuestas pueden variar. Elija dos o tres contramedidas y explique cómo eliminarían el impacto potencial.