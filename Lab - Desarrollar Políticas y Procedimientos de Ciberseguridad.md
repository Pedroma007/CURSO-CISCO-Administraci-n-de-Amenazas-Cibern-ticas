---
title: Lab - Desarrollar Políticas y Procedimientos de Ciberseguridad
...
* Política de seguridad de la información: Guía de desarrollo para grandes y pequeñas empresas (pdf)
...
1. Varias cuentas de usuario permitieron privilegios no autorizados y de más nivel. Estas cuentas accedían a sistemas e información sin autorización formal.
1. Varios dispositivos y sistemas permitieron el acceso remoto no seguro.
1. El 40% de todas las contraseñas de la organización auditadas se descifraron en 6 horas.
1. El vencimiento de la contraseña no estaba estandarizado.
1. Los archivos confidenciales se encontraron sin cifrar en los dispositivos de los usuarios.
1. Varios puntos de acceso inalámbrico utilizaron WEP para el cifrado y la autenticación.
1. La evidencia indica que se envió correo electrónico confidencial desde y hacia los hogares de los empleados y los dispositivos móviles sin cifrado.
1. Los registros de detección de intrusiones se revisaban y analizaban con poca frecuencia.
1. Los empleados utilizaron dispositivos con datos confidenciales de la empresa para uso privado.
1. Los dispositivos de los empleados quedaban desatendidos y los empleados fallaban en cerrar sesión en la red y los sistemas de datos de la empresa.
1. Se realizaron configuraciones y actualizaciones de dispositivos inconsistentes.
1. Se establecieron varias reglas de firewall para permitir todo el tráfico, a menos que se deniegue específicamente.
1. Los servidores de la empresa no se actualizaron con los últimos parches.
1. El servidor web de la intranet permitió a los usuarios cambiar su información personal, incluida la información de contacto.
...
![image](https://hackmd.io/_uploads/H1Er_hA9bg.png)
